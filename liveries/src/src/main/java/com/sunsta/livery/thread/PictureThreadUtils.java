package com.sunsta.livery.thread;
...
public final class PictureThreadUtils {
    ...
    public static void cancel(ExecutorService executorService) {
        if (executorService instanceof ThreadPoolExecutor4Util) {
            ...
            LaLog.e("LogUtils", "The executorService is not PictureThreadUtils's pool.");
        }
    }
    ...
    private static <T> void execute(final ExecutorService pool, final Task<T> task,
        ...
        synchronized (TASK_TASKINFO_MAP) {
            if (TASK_TASKINFO_MAP.get(task) != null) {
                LaLog.e("PictureThreadUtils", "Task can only be executed once.");
                return;
            }
    ...
    static final class ThreadPoolExecutor4Util extends ThreadPoolExecutor {
        ...
        public void execute(@NonNull Runnable command) {
            ...
            try {
                ...
                LaLog.e("PictureThreadUtils", "This will not happen!");
            ...
            Thread t = new Thread(r, namePrefix + getAndIncrement()) {
                ...
                public void run() {
                    try {
                        ...
                        LaLog.e("PictureThreadUtils", "Request threw uncaught throwable", t);
                    }
                }
            };
    ...
    public abstract static class SimpleTask<T> extends Task<T> {
        ...
        public void onCancel() {
            LaLog.e("PictureThreadUtils", "onCancel: " + Thread.currentThread());
        }

        @Override
        public void onFail(Throwable t) {
            LaLog.e("PictureThreadUtils", "onFail: ", t);
        }
