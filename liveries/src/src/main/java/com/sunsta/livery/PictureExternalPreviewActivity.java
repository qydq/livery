...
import com.sunsta.livery.broadcast.BroadcastAction;
import com.sunsta.livery.broadcast.BroadcastManager;
...
import com.sunsta.livery.listener.OnImageCompleteCallback;
...
import com.sunsta.livery.widget.longimage.ImageSource;
import com.sunsta.livery.widget.longimage.ImageViewState;
...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public int getResourceId() {
        return R.layout.an_activity_external_preview;
    }
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (contentView == null) {
                contentView = LayoutInflater.from(container.getContext())
                        .inflate(R.layout.an_image_preview, container, false);
            ...
            if (media != null) {
                ...
                ivPlay.setOnClickListener(v -> {
                    if (PictureSelectionConfig.customVideoPlayCallback != null) {
                        ...
                        FasteIntent.startPictureVideoPlayActivity(container.getContext(), bundle, PictureConfig.PREVIEW_VIDEO_CODE);
                    }
                });
            }
