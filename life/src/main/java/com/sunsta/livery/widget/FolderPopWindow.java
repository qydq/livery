    ...
    public FolderPopWindow(Context context, PictureSelectionConfig config) {
        ...
        if (config.style != null) {
            ...
            if (config.isWeChatStyle) {
                this.drawableUp = ContextCompat.getDrawable(context, R.drawable.ic_color_wechat_up);
                this.drawableDown = ContextCompat.getDrawable(context, R.drawable.ic_color_wechat_down);
            } else {
                if (config.upResId != 0) {
