 ...
 * 中文描述：ImageFiles工具类 * <br/>
 * <br/><a href="https://zhihu.com/people/qydq">
 * --------温馨提示：知识是应该分享的，an系列框架可以点击这里关注我获取更详细的信息</a><br/>
 * <h3><a href="https://zhuanlan.zhihu.com/p/80668416">版权声明：(C) 2016 The Android Developer Sunst</a></h3>
 * <br>创建日期（可选）：2016/6/7 0007 9:39
 * <br>邮件Email：qyddai@gmail.com
 * <br>Github：<a href ="https://qydq.github.io">qydq</a>
 * <br>知乎主页：<a href="https://zhihu.com/people/qydq">Bgwan</a>
 * @author sunst // sunst0069
 * @version 2.0 |   2019/10/07           |   ImageFiles工具类
 */
public class TImageFiles {
    ...
    public static boolean checkMimeType(Context context, String minType) {
        ...
        if (!isPicture)
            Toast.makeText(context, context.getResources().getText(R.string.text_type_not_image), Toast.LENGTH_SHORT).show();
        return isPicture;
    }
