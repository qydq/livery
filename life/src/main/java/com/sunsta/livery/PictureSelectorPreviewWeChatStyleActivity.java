...
import com.sunsta.livery.adapter.PictureWeChatPreviewGalleryAdapter;
import com.sunsta.bear.config.PictureMimeType;
import com.sunsta.livery.decoration.GridSpacingItemDecoration;
import com.sunsta.livery.decoration.WrapContentLinearLayoutManager;
...
public class PictureSelectorPreviewWeChatStyleActivity extends PicturePreviewActivity {
    ...
    protected void initWidgets() {
        ...
        mRvGallery.addItemDecoration(new GridSpacingItemDecoration(Integer.MAX_VALUE, ScreenUtils.dip2px(8), false));
    ...
    public void initPictureSelectorStyle() {
        ...
        if (config.style != null) {
            ...
            if (config.style.pictureWeChatLeftBackStyle != 0) {
                ...
                picture_left_back.setImageResource(R.drawable.ic_white_back);
            }
